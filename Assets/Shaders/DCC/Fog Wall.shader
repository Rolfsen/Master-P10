...
Shader "DCC/Fog Wall" {
    Properties {
        ...
        _TotalOpacityIntensity ("Total Opacity Intensity", Range(0, 3)) = 3
...
////// Emissive:
                ...
                float node_922 = saturate(lerp(0.0,saturate((_DissolveMin + ( ((1.0 - (((1.0 - _DissolveAmount)*1.5+-0.6)+_DissolveNoise_var.r)) - node_8219) * (_DissolveMax - _DissolveMin) ) / (1.0 - node_8219))),saturate((node_1877 + ( (length(float2((i.uv0.r.r*3.0+-1.5),(i.uv0.g.r*3.0+-2.0))) - node_7216) * ((_DissolveAmount*13.0+-10.0) - node_1877) ) / (2.0 - node_7216)))));
                ...
                fixed4 finalRGBA = fixed4(finalColor,lerp(lerp(node_4684,saturate((lerp(node_7468,lerp((1.0 - _Fog2MapIntensity),node_1807.r,node_1807.r),node_7468)*_TotalOpacityIntensity)),1.0),node_4684,node_9506.r));
