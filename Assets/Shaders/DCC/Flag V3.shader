    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                v.vertex.xyz += (_WindIntensity*(((v.normal*(_WindNoiseIntensity*_Noise_var.rgb))+sin((normalize(float3(_XWindDirection,_YWindDirection,_ZWindDirection))*GerstnerVertex( _WaveSharpness , _WaveHeight , _WaveSpread , _WindFrequency , (_WaveTimeOffset+node_1848.g) , dot(node_4132,mul(unity_ObjectToWorld, v.vertex).rgb.rg) , node_4132 ))))*o.vertexColor.b));
